...
```{r}
errors_Seedlings <- rbind(errors_Seedlings_Header, errors_blank, errors_Seedlings_Count, errors_blank, errors_Seedlings_Frac, errors_blank, errors_Seedlings_Height, errors_blank, errors_Seedlings_Status, errors_blank, errors_Seedlings_LifeForm, errors_blank, errors_Seedlings_Values)

remove(errors_Seedlings_Header, errors_Seedlings_Count, errors_Seedlings_Frac, errors_Seedlings_Height, errors_Seedlings_Status, errors_Seedlings_LifeForm, errors_Seedlings_Values)
```
...
```{r}
errors_HerbsObs <- rbind(errors_HerbsObs_Cover, errors_blank, errors_HerbsObs_Species, errors_blank, errors_HerbsObs_Status)

remove(errors_HerbsObs_Cover, errors_HerbsObs_Species, errors_HerbsObs_Status)
```

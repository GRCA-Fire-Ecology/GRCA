...
# errors_Fuels1000_DecayCl <- unique(errors_Fuels1000_DecayCl)
# errors_errors_Fuels1000_FuelConst <- unique(errors_Fuels1000_FuelConst)
# errors_Fuels1000_NumTran <- unique(errors_Fuels1000_NumTran)
# errors_Fuels1000_TranLen_N <- unique(errors_Fuels1000_TranLen_N)
# errors_Fuels1000_TranLen_S <- unique(errors_Fuels1000_TranLen_S)
# errors_Fuels1000_LogNo <- unique(errors_Fuels1000_LogNo)
# errors_Fuels1000_TransNum <- unique(errors_Fuels1000_TransNum)
# errors_Fuels1000_Slope <- unique(errors_Fuels1000_Slope)
# errors_Fuels1000_Dia <- unique(errors_Fuels1000_Dia)

# errors_Fuels1000 <- unique(rbind(errors_Fuels1000_DecayCl, errors_Fuels1000_FuelConst,errors_Fuels1000_NumTran, errors_Fuels1000_TranLen_N, errors_Fuels1000_TranLen_S, errors_Fuels1000_LogNo,errors_Fuels1000_TransNum, errors_Fuels1000_Slope, errors_Fuels1000_Dia))

errors_Fuels1000 <- rbind(errors_Fuels1000_DecayCl, errors_blank, errors_Fuels1000_FuelConst, errors_blank, errors_Fuels1000_NumTran, errors_Fuels1000_TranLen_N, errors_Fuels1000_TranLen_S, errors_blank, errors_Fuels1000_LogNo, errors_blank, errors_Fuels1000_TransNum, errors_Fuels1000_Slope, errors_Fuels1000_Dia)

remove(errors_Fuels1000_DecayCl, errors_Fuels1000_FuelConst, errors_Fuels1000_NumTran, errors_Fuels1000_TranLen_N, errors_Fuels1000_TranLen_S, errors_Fuels1000_LogNo, errors_Fuels1000_TransNum, errors_Fuels1000_Slope, errors_Fuels1000_Dia)
```
...
```{r}
# Combine
errors_Trees_Height <- unique(rbind(errors_Trees_Height_Standing, errors_Trees_Height_Pole, errors_Trees_Height_Overstory))

remove(errors_Trees_Height_Standing, errors_Trees_Height_Pole, errors_Trees_Height_Overstory)
```
...
errors_all <- rbind(errors_Fuels1000, errors_blank, errors_FuelsDuffLitt, errors_blank, errors_FuelsFine, errors_blank, errors_Trees)

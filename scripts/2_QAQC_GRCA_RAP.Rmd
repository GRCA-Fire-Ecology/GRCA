...
path_errors_name <- "2018 GRCA RAP QAQC Errors"
```
...
```{r}
# Load in data
Fuels1000_all_N <- read.csv(paste0(path_data_N, "Surface Fuels - 1000Hr_XPT.csv"), quote = "")
FuelsDuffLitt_all_N <- read.csv(paste0(path_data_N, "Surface Fuels - Duff_Litter_XPT.csv"), quote = "")
FuelsFine_all_N <- read.csv(paste0(path_data_N, "Surface Fuels - Fine_XPT.csv"), quote = "")
PostBurn_all_N <- read.csv(paste0(path_data_N, "Post Burn Severity_XPT.csv"), quote = "")
Trees_all_N <- read.csv(paste0(path_data_N, "Trees - Individuals (metric)_XPT.csv"), quote = "")
...
```{r}
# Load in data
Fuels1000_all_S <- read.csv(paste0(path_data_S, "Surface Fuels - 1000Hr_XPT.csv"), quote = "")
FuelsDuffLitt_all_S <- read.csv(paste0(path_data_S, "Surface Fuels - Duff_Litter_XPT.csv"), quote = "")
FuelsFine_all_S <- read.csv(paste0(path_data_S, "Surface Fuels - Fine_XPT.csv"), quote = "")
PostBurn_all_S <- read.csv(paste0(path_data_S, "Post Burn Severity_XPT.csv"), quote = "")
Trees_all_S <- read.csv(paste0(path_data_S, "Trees - Individuals (metric)_XPT.csv"), quote = "")
...
Fuels1000_data <- Fuels1000_all %>%
  filter(is.na(Visited), Year %in% c(2018))
...
[Problem:]{.underline} Extra or missing data points in RAP plots. Plots with no course woody debris should be verified.
...
query_message <- "Correct Value = 1. Number of Transects" 
...
query <- "Fuel 1000 Header"
query_message <- "Correct Value = 2. Number of Transects" 
values_data <- data$NumTran
values_valid <- 2
values_check <- values_data == values_valid
...
data <- Fuels1000_header
query <- "Fuel 1000 Header" 
query_message <- "Correct Value = 50. Transect Length" 
...
```{r}
# Combine
errors_Fuels1000_Header <- unique(rbind(errors_Fuels1000_NumTran_1, errors_Fuels1000_NumTran_2, errors_Fuels1000_TranLen, errors_Fuels1000_FieldTeam, errors_Fuels1000_EntryTeam))

remove(errors_Fuels1000_NumTran_1, errors_Fuels1000_NumTran_2, errors_Fuels1000_TranLen, errors_Fuels1000_FieldTeam, errors_Fuels1000_EntryTeam)
...
query_message <- "Correct Value = Mixed Conifer. Fuel Constant"
...
query <- "Fuel 1000 FuelConst"
query_message <- "Correct Value = PIPO. Fuel Constant"
values_data <- data$CWDFuConSt
values_valid <- "PIPO"
values_check <- values_data == values_valid
...
query <- "Fuel 1000 FuelConst"
query_message <- "Correct Value = PIED. Fuel Constant"
values_data <- data$CWDFuConSt
values_valid <- "PIED"
values_check <- values_data == values_valid
...
if(nrow(errors_Fuels1000_FuelConst) > 1) {
...
query_message <- "Correct Value = 1. Transect Number"
values_data <- data$Transect
values_valid <- c(1)
values_check <- values_data %in% values_valid

# Identify errors
errors_Fuels1000_Transect_1 <- qaqc(data, query, query_message, values_check)
```
...
data <- Fuels1000_data %>% 
  filter(MacroPlot.Purpose %in% c("Burnt Corral", "Fawn Spring", "Hwy 67", "Range", "Spring Canyon", "Thompson", "Tipover", "Tusayan Pueblo (Thinning)"))
query <- "Fuel 1000 Transect"
query_message <- "Correct Value = 1 or 2. Transect Number"
values_data <- data$Transect
values_valid <- c(1, 2)
values_check <- values_data %in% values_valid

# Identify errors
errors_Fuels1000_Transect_2 <- qaqc(data, query, query_message, values_check)
```

#### Combine Transect Errors

```{r}
# Combine
errors_Fuels1000_Transect <- unique(rbind(errors_Fuels1000_Transect_1, errors_Fuels1000_Transect_2))

remove(errors_Fuels1000_Transect_1, errors_Fuels1000_Transect_2)

if(nrow(errors_Fuels1000_Transect) > 1) {
  errors_Fuels1000_Transect <- errors_Fuels1000_Transect %>%
    filter(Error != "No Error")
} else {
  errors_Fuels1000_Transect <- errors_Fuels1000_Transect}
```
...
query_message <- "Correct Value = 10. Complete Sample Locations"
values_data <- data$sum_hits
values_valid <- 10
values_check <- values_data == values_valid

# Identify errors
errors_FuelsDuffLitt_Complete_10 <- qaqc(data, query, query_message, values_check)
```
...
data <- merge(FuelsDuffLitt_data, data_temp, by = c("MacroPlot.Name", "Date"), all = T) %>% 
  filter(MacroPlot.Purpose %in% c("Burnt Corral", "Fawn Spring", "Hwy 67", "Range", "Spring Canyon", "Thompson", "Tipover", "Tusayan Pueblo (Thinning)"))
query <- "Fuel DL Complete" 
query_message <- "Correct Value = 20. Complete Sample Locations"
values_data <- data$sum_hits
values_valid <- 20
values_check <- values_data == values_valid

# Identify errors
errors_FuelsDuffLitt_Complete_20 <- qaqc(data, query, query_message, values_check)
```

#### Combine Complete Errors

```{r}
# Combine
errors_FuelsDuffLitt_Complete <- unique(rbind(errors_FuelsDuffLitt_Complete_10, errors_FuelsDuffLitt_Complete_20))

remove(errors_FuelsDuffLitt_Complete_10, errors_FuelsDuffLitt_Complete_20)
...
```{r}
# Combine
errors_FuelsDuffLitt_Header <- unique(rbind(errors_FuelsDuffLitt_NumTran_1, errors_FuelsDuffLitt_NumTran_2, errors_FuelsDuffLitt_FieldTeam, errors_FuelsDuffLitt_EntryTeam))

remove(errors_FuelsDuffLitt_NumTran_1, errors_FuelsDuffLitt_NumTran_2, errors_FuelsDuffLitt_FieldTeam, errors_FuelsDuffLitt_EntryTeam)
...
if(nrow(errors_FuelsDuffLitt_FuelConst) > 1) {
...
# Identify errors
errors_FuelsDuffLitt_Transect_1 <- qaqc(data, query, query_message, values_check)
```
...
# Identify errors
errors_FuelsDuffLitt_Transect_2 <- qaqc(data, query, query_message, values_check)
```
...
```{r}
# Combine
errors_FuelsDuffLitt_Transect <- unique(rbind(errors_FuelsDuffLitt_Transect_1, errors_FuelsDuffLitt_Transect_2))

remove(errors_FuelsDuffLitt_Transect_1, errors_FuelsDuffLitt_Transect_2)

if(nrow(errors_FuelsDuffLitt_Transect) > 1) {
  errors_FuelsDuffLitt_Transect <- errors_FuelsDuffLitt_Transect %>%
    filter(Error != "No Error")
} else {
  errors_FuelsDuffLitt_Transect <- errors_FuelsDuffLitt_Transect}
```
...
query_message <- "Correct Value = 1. Complete Transects" 
values_data <- data$sum_hits
values_valid <- 1
values_check <- values_data == values_valid

# Identify errors
errors_FuelsFine_Complete_1 <- qaqc(data, query, query_message, values_check)
```
...
data <- merge(FuelsFine_data, data_temp, by = c("MacroPlot.Name", "Date"), all = T) %>% 
  filter(MacroPlot.Purpose %in% c("Burnt Corral", "Fawn Spring", "Hwy 67", "Range", "Spring Canyon", "Thompson", "Tipover", "Tusayan Pueblo (Thinning)"))
query <- "Fuel Fine Complete" 
query_message <- "Correct Value = 2. Complete Transects" 
values_data <- data$sum_hits
values_valid <- 2
values_check <- values_data == values_valid

# Identify errors
errors_FuelsFine_Complete_2 <- qaqc(data, query, query_message, values_check)
```
...
```{r}
# Combine
errors_FuelsFine_Complete <- unique(rbind(errors_FuelsFine_Complete_1, errors_FuelsFine_Complete_2))

remove(errors_FuelsFine_Complete_1, errors_FuelsFine_Complete_2)
...
```{r}
# Combine
errors_FuelsFine_Header <- unique(rbind(errors_FuelsFine_NumTran_1, errors_FuelsFine_NumTran_2, errors_FuelsFine_OneHrTranLen, errors_FuelsFine_TenHrTranLen, errors_FuelsFine_HunHrTranLen, errors_FuelsFine_FieldTeam, errors_FuelsFine_EntryTeam))

remove(errors_FuelsFine_NumTran_1, errors_FuelsFine_NumTran_2, errors_FuelsFine_OneHrTranLen, errors_FuelsFine_TenHrTranLen, errors_FuelsFine_HunHrTranLen, errors_FuelsFine_FieldTeam, errors_FuelsFine_EntryTeam)
...
if(nrow(errors_FuelsFine_FuelConst) > 1) {
...
# Identify errors
errors_FuelsFine_Transect_1 <- qaqc(data, query, query_message, values_check)
```
...
# Identify errors
errors_FuelsFine_Transect_2 <- qaqc(data, query, query_message, values_check)
```
...
```{r}
# Combine
errors_FuelsFine_Transect <- unique(rbind(errors_FuelsFine_Transect_1, errors_FuelsFine_Transect_2))

remove(errors_FuelsFine_Transect_1, errors_FuelsFine_Transect_2)

if(nrow(errors_FuelsFine_Transect) > 1) {
  errors_FuelsFine_Transect <- errors_FuelsFine_Transect %>%
    filter(Error != "No Error")
} else {
  errors_FuelsFine_Transect <- errors_FuelsFine_Transect}
```
...
# Identify errors
errors_PostBurn_Complete_10 <- qaqc(data, query, query_message, values_check)
```
...
# Identify errors
errors_PostBurn_Complete_20 <- qaqc(data, query, query_message, values_check)
```
...
```{r}
# Combine
errors_PostBurn_Complete <- unique(rbind(errors_PostBurn_Complete_10, errors_PostBurn_Complete_20))

remove(errors_PostBurn_Complete_10, errors_PostBurn_Complete_20)
...
```{r}
# Combine
errors_PostBurn_Header <- unique(rbind(errors_PostBurn_NumTran_1, errors_PostBurn_NumTran_2, errors_PostBurn_TranLen, errors_PostBurn_NumPtsTran, errors_PostBurn_PlotType, errors_PostBurn_PtArea, errors_PostBurn_FieldTeam, errors_PostBurn_EntryTeam))

remove(errors_PostBurn_NumTran_1, errors_PostBurn_NumTran_2, errors_PostBurn_TranLen, errors_PostBurn_NumPtsTran, errors_PostBurn_PlotType, errors_PostBurn_PtArea, errors_PostBurn_FieldTeam, errors_PostBurn_EntryTeam)
...
# Identify errors
errors_PostBurn_Transect_1 <- qaqc(data, query, query_message, values_check)
```
...
# Identify errors
errors_PostBurn_Transect_2 <- qaqc(data, query, query_message, values_check)
```
...
```{r}
# Combine
errors_PostBurn_Transect <- unique(rbind(errors_PostBurn_Transect_1, errors_PostBurn_Transect_2))

remove(errors_PostBurn_Transect_1, errors_PostBurn_Transect_2)

if(nrow(errors_PostBurn_Transect) > 1) {
  errors_PostBurn_Transect <- errors_PostBurn_Transect %>%
    filter(Error != "No Error")
} else {
  errors_PostBurn_Transect <- errors_PostBurn_Transect}
```
...
[Problem:]{.underline} Missing data points in RAP plots. Plots with no trees should be verified.
...
data <- Trees_data %>% 
   filter(DBH > 15.0)
query <- "Trees Height" 
query_message <- paste0("DBH = overstory. Possible outlier. Height")
values_data <- data$Ht
values_valid <- max_Ht
values_check <- (values_data <= values_valid) %>% replace_na(TRUE)
...
[Problem]{.underline}: Assess UV columns for relevant information.

[Procedure]{.underline}:

-   UV1 contains the azimuth for overstory trees on RAP plots. Check that Azimuth values are reasonable.

```{r}
# Set parameters
data <- Trees_data
query <- "Trees UV1"
query_message <- paste0("Tag ", data$TagNo, ". ", "Azimuth")
...
-   Check that UV2 is blank for all plots
...
-   Check that UV3 is blank for all plots
...
[Problem:]{.underline} Missing data points in RAP plots. Plots with no seedlings should be verified.
...
[Problem:]{.underline} Missing data points in RAP plots. Plots with no observed herbs should be verified.
...
if(nrow(errors_HerbsObs_Cover) > 1) {
  errors_HerbsObs_Cover <- errors_HerbsObs_Cover %>%
    filter(Error != "No Error")
} else {
  errors_HerbsObs_Cover <- errors_HerbsObs_Cover}
```
...
if(nrow(errors_HerbsObs_Species) > 1) {
  errors_HerbsObs_Species <- errors_HerbsObs_Species %>%
    filter(Error != "No Error")
} else {
  errors_HerbsObs_Species <- errors_HerbsObs_Species}
```
...
```{r}
errors_HerbsObs <- rbind(errors_HerbsObs_Complete, errors_blank, errors_HerbsObs_Header, errors_blank, errors_HerbsObs_Cover, errors_blank, errors_HerbsObs_Species, errors_blank, errors_HerbsObs_Status, errors_blank, errors_HerbsObs_Zero)

remove(errors_HerbsObs_Complete, errors_HerbsObs_Header, errors_HerbsObs_Cover, errors_HerbsObs_Species, errors_HerbsObs_Status, errors_HerbsObs_Zero)
```
...
```{r}
# Save to master error list 
# errors_all <- unique(rbind(errors_Fuels1000, errors_FuelsDuffLitt, errors_FuelsFine, errors_PostBurn, errors_Trees, errors_Seedlings, errors_HerbsObs))

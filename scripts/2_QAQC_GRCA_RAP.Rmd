...
```{r}
# Remove extra data
remove(Fuels1000_all_N, Fuels1000_all_S, FuelsDuffLitt_all_N, FuelsDuffLitt_all_S, FuelsFine_all_N, FuelsFine_all_S, HerbsObs_all_N, HerbsObs_all_S, Seedlings_all_N, Seedlings_all_S, Trees_all_N, Trees_all_S, PostBurn_all_N, PostBurn_all_S)
```
...
```{r}
unique(Fuels1000_all$MacroPlot.Purpose)

z_meta <- as.data.frame(unique(Fuels1000_all$MacroPlot.Purpose))
z_FuConSt <- Fuels1000_data %>% 
  group_by(MacroPlot.Purpose) %>% 
  summarize(CWDFuConSt = unique(CWDFuConSt))
z_NumTran <- Fuels1000_header %>% 
  group_by(MacroPlot.Purpose) %>% 
  summarize(NumTran = unique(NumTran))
z_TranLen <- Fuels1000_header %>% 
  group_by(MacroPlot.Purpose) %>% 
  summarize(TranLen = unique(TranLen))
```
...
# Identify errors
errors_Fuels1000_FuelConst_MixCon <- unique(qaqc(data, query, query_message, values_check))
```
...
# Identify errors
errors_Fuels1000_FuelConst_PIPO <- unique(qaqc(data, query, query_message, values_check))
```
...
# Identify errors
errors_Fuels1000_FuelConst_PIED <- unique(qaqc(data, query, query_message, values_check))
```
...
```{r}
# errors_Fuels1000 <- unique(rbind(errors_Fuels1000_DecayCl, errors_Fuels1000_FuelConst, errors_Fuels1000_Header, errors_Fuels1000_LogNo,errors_Fuels1000_TransNum, errors_Fuels1000_Slope, errors_Fuels1000_Dia))

errors_Fuels1000 <- rbind(errors_Fuels1000_DecayCl, errors_blank, errors_Fuels1000_FuelConst, errors_blank, errors_Fuels1000_Header, errors_blank, errors_Fuels1000_LogNo, errors_blank, errors_Fuels1000_TransNum_1, errors_Fuels1000_TransNum_2, errors_Fuels1000_Slope, errors_Fuels1000_Dia)

remove(errors_Fuels1000_DecayCl, errors_Fuels1000_FuelConst, errors_Fuels1000_Header, errors_Fuels1000_LogNo, errors_Fuels1000_TransNum_1, errors_Fuels1000_TransNum_2, errors_Fuels1000_Slope, errors_Fuels1000_Dia)
```
...
# Identify errors
errors_FuelsDuffLitt_FuelConst_MixCon <- unique(qaqc(data, query, query_message, values_check))
```
...
# Identify errors
errors_FuelsDuffLitt_FuelConst_PIPO <- unique(qaqc(data, query, query_message, values_check))
```
...
# Identify errors
errors_FuelsDuffLitt_FuelConst_PIED <- unique(qaqc(data, query, query_message, values_check))
```
...
# Identify errors
errors_FuelsDuffLitt_Hits_10 <- unique(qaqc(data, query, query_message, values_check))
```
...
# Identify errors
errors_FuelsDuffLitt_Hits_20 <- unique(qaqc(data, query, query_message, values_check))
```
...
errors_FuelsDuffLitt <- rbind(errors_FuelsDuffLitt_FuelConst, errors_blank,  errors_FuelsDuffLitt_Header, errors_blank, errors_FuelsDuffLitt_Hits, errors_blank,  errors_FuelsDuffLitt_LittDep, errors_FuelsDuffLitt_DuffDep)

remove(errors_FuelsDuffLitt_FuelConst, errors_FuelsDuffLitt_Header, errors_FuelsDuffLitt_Hits, errors_FuelsDuffLitt_LittDep, errors_FuelsDuffLitt_DuffDep)
```
...
[Problem:]{.underline} Extra or missing data points in RAP plots. There should be 4 transects with 1 sample point per transect. 
...
errors_FuelsFine <- rbind(errors_FuelsFine_FuelConst, errors_blank,  errors_FuelsFine_Header, errors_blank, errors_FuelsFine_Hits, errors_blank,  errors_FuelsFine_TransNum, errors_FuelsFine_Azimuth, errors_FuelsFine_Slope, errors_FuelsFine_OneHr, errors_FuelsFine_TenHr, errors_FuelsFine_HunHr)

remove(errors_FuelsFine_FuelConst, errors_FuelsFine_Header, errors_FuelsFine_Hits, errors_FuelsFine_TransNum, errors_FuelsFine_Azimuth, errors_FuelsFine_Slope, errors_FuelsFine_OneHr, errors_FuelsFine_TenHr, errors_FuelsFine_HunHr)
```
...
[Problem:]{.underline} Extra or missing data points in RAP plots. There should be 4 transects with 10 sample points per transect.

...
path_errors_name <- "2019 GRCA I&M QAQC Errors"
```
...
```{r}
# Load in data
Fuels1000_all_M <- read.csv(paste0(path_data_M, "Surface Fuels - 1000Hr_XPT.csv"), quote = "")
FuelsDuffLitt_all_M <- read.csv(paste0(path_data_M, "Surface Fuels - Duff_Litter_XPT.csv"), quote = "")
FuelsFine_all_M <- read.csv(paste0(path_data_M, "Surface Fuels - Fine_XPT.csv"), quote = "")
PostBurn_all_M <- read.csv(paste0(path_data_M, "Post Burn Severity_XPT.csv"), quote = "")
Trees_all_M <- read.csv(paste0(path_data_M, "Trees - Individuals (metric)_XPT.csv"), quote = "")
```
...
```{r}
# Load in data
Fuels1000_all_P <- read.csv(paste0(path_data_P, "Surface Fuels - 1000Hr_XPT.csv"), quote = "")
FuelsDuffLitt_all_P <- read.csv(paste0(path_data_P, "Surface Fuels - Duff_Litter_XPT.csv"), quote = "")
FuelsFine_all_P <- read.csv(paste0(path_data_P, "Surface Fuels - Fine_XPT.csv"), quote = "")
PostBurn_all_P <- read.csv(paste0(path_data_P, "Post Burn Severity_XPT.csv"), quote = "")
Trees_all_P <- read.csv(paste0(path_data_P, "Trees - Individuals (metric)_XPT.csv"), quote = "")
```
...
[Problem:]{.underline} Missing data points in I&M plots. Plots with no trees should be verified.
...
query_message <- paste0("Non-post read. Char Height")
...
query_message <- paste0("Non-post read. Scorch Height")
...
query_message <- paste0("Non-post read. Crown Scorch Percent")

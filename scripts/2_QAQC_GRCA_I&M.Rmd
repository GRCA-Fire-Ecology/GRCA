...
errors_FuelsDuffLitt_Hits <- unique(errors_FuelsDuffLitt_Hits)
```
...
errors_all <- condformat(errors_all[1:(nrow(errors_all)), 1:7]) %>% 
  rule_fill_discrete(columns = c("SavedQuery","MacroPlot.Name","Date","Error", "Fixed", "Explanation", "Queryers"), 
...
condformat2excel(errors_all, paste0(path_errors, "errors_GRCA_I&M_formatted.xlsx"), overwrite_wb = TRUE)
```

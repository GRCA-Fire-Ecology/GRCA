...
cf_post <- as.data.frame(grepl("PBSev", errors_all$SavedQuery, fixed = TRUE) | grepl(" Post", errors_all$SavedQuery, fixed = TRUE))
colnames(cf_post) <- c("Post")
errors_all_cf <- cbind(errors_all, cf_post) %>% 

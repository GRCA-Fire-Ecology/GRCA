...
[Problem:]{.underline} Extra or missing data points in RAP plots. Plots with no trees should be verified.
...
[Problem:]{.underline} Extra or missing data points in RAP plots. Plots with no seedlings should be verified.
...
```{r}
errors_Seedlings <- rbind(errors_Seedlings_Count, errors_blank, errors_Seedlings_Header, errors_blank, errors_Seedlings_Height, errors_blank, errors_Seedlings_Complete, errors_blank, errors_Seedlings_LifeForm,  errors_blank, errors_Seedlings_Quadrat, errors_blank, errors_Seedlings_Status, errors_blank, errors_Seedlings_SubFrac, errors_blank, errors_Seedlings_Transect)

remove(errors_Seedlings_Count, errors_Seedlings_Header, errors_Seedlings_Height, errors_Seedlings_Complete, errors_Seedlings_LifeForm, errors_Seedlings_Quadrat, errors_Seedlings_Status, errors_Seedlings_SubFrac, errors_Seedlings_Transect)
```
...
[Problem:]{.underline} Extra or missing data points in RAP plots. Plots with no observed herbs should be verified.
...
```{r}
errors_HerbsObs <- rbind(errors_HerbsObs_Cover, errors_blank, errors_HerbsObs_Complete, errors_blank, errors_HerbsObs_Species, errors_blank, errors_HerbsObs_Status)

remove(errors_HerbsObs_Cover, errors_HerbsObs_Complete, errors_HerbsObs_Species, errors_HerbsObs_Status)
```

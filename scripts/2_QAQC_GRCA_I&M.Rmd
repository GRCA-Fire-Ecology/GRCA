...
# Identify errors
errors_Fuels1000_FuelConst <- unique(qaqc(data, query, query_message, values_check))
```
...
query_message <- paste0("Log ", data$LogNum, ". ", "Duplicate")
...
# Identify errors
errors_FuelsDuffLitt_FuelConst <- unique(qaqc(data, query, query_message, values_check))
```
...
# Identify errors
errors_FuelsFine_FuelConst <- unique(qaqc(data, query, query_message, values_check))
```

...
data <- Trees_data %>% 
  filter(Monitoring.Status %in% c("01Post", "02Post", "03Post", "04Post"),
         ...
         !TagNo == 0)
query <- "Trees Post Char FMH Dead" 
...
data <- Trees_data %>% 
  filter(Monitoring.Status %in% c("01Post", "02Post", "03Post", "04Post"),
         Status == "L")
query <- "Trees Post Char FMH Live" 
query_message <- "Char Height"  
values_data <- data$CharHt
values_valid <- max(29)
values_check <- !values_data < values_valid
...
data <- Trees_data %>% 
  filter(Monitoring.Status %in% c("01Post", "02Post", "03Post", "04Post"),
         CrwnCl %in% c("DD", "BBD", "CUS"))
query <- "Trees Post Scorch FMH DD" 
...
data <- Trees_data %>% 
  filter(Monitoring.Status %in% c("01Post", "02Post", "03Post", "04Post"),
         !CrwnCl %in% c("DD", "BBD", "CUS"),
         Status == "D")
query <- "Trees Post Scorch FMH Dead"
...
data <- Trees_data %>% 
  filter(Monitoring.Status %in% c("01Post", "02Post", "03Post", "04Post"),
         Status == "L")
query <- "Trees Post Scorch FMH Live" 
query_message <- "Scorch Height"  
values_data <- data$ScorchHt
values_valid <- max(39)
values_check <- !values_data < values_valid

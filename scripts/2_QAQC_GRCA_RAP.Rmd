...
# errors_FuelsDuffLitt <- unique(rbind(errors_FuelsDuffLitt_FuelConst, errors_FuelsDuffLitt_NumTran, errors_FuelsDuffLitt_Hits, errors_FuelsDuffLitt_Values))
...
# Identify errors
errors_FuelsFine_FuelConst_MixCon <- unique(qaqc(data, query, query_message, values_check))
```
...
# Identify errors
errors_FuelsFine_FuelConst_PIPO <- unique(qaqc(data, query, query_message, values_check))
```
...
# Identify errors
errors_FuelsFine_FuelConst_PIED <- unique(qaqc(data, query, query_message, values_check))
```
...
# Identify errors
errors_FuelsFine_Hits_1 <- unique(qaqc(data, query, query_message, values_check))
```
...
# Identify errors
errors_FuelsFine_Hits_2 <- unique(qaqc(data, query, query_message, values_check))
```
...
# Identify errors
errors_PostBurn_Hits_10 <- unique(qaqc(data, query, query_message, values_check))
```
...
# Identify errors
errors_PostBurn_Hits_20 <- unique(qaqc(data, query, query_message, values_check))
```

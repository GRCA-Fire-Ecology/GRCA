...
[Problem:]{.underline} Missing data points in WACA plots. Plots with no trees should be verified.
...
# errors_blank_Fuels1000 <- condformat(errors_blank_Fuels1000[1:1, 1:7]) %>% 
#   rule_fill_discrete(columns = 1:7, 
#                      colours = c("PROTOCOL - FUEL 1000" = "#969696"))
# 
...
# errors_blank_FuelsDuffLitt <- condformat(errors_blank_FuelsDuffLitt[1:1, 1:7]) %>% 
#   rule_fill_discrete(columns = 1:7, 
#                      colours = c("PROTOCOL - FUEL DUFF LITTER" = "#969696"))
# 
# errors_blank_FuelsFine <- data.frame("SavedQuery" = "PROTOCOL - FUEL FINE","MacroPlot.Name" = "","Date" = "","Error" = "", "Fixed" = "", "Explanation" = "", "Queryers" = "")
# errors_blank_FuelsFine <- condformat(errors_blank_FuelsFine[1:1, 1:7]) %>% 
#   rule_fill_discrete(columns = 1:7, 
#                      colours = c("PROTOCOL - FUEL FINE" = "#969696"))
# 
# errors_blank_PostBurn <- data.frame("SavedQuery" = "PROTOCOL - POST BURN SEVERITY","MacroPlot.Name" = "","Date" = "","Error" = "", "Fixed" = "", "Explanation" = "", "Queryers" = "")
# errors_blank_PostBurn <- condformat(errors_blank_PostBurn[1:1, 1:7]) %>% 
#   rule_fill_discrete(columns = 1:7, 
#                      colours = c("PROTOCOL - POST BURN SEVERITY" = "#969696"))
# 
# errors_blank_Trees <- data.frame("SavedQuery" = "PROTOCOL - TREES","MacroPlot.Name" = "","Date" = "","Error" = "", "Fixed" = "", "Explanation" = "", "Queryers" = "")
# errors_blank_Trees <- condformat(errors_blank_Trees[1:1, 1:7]) %>% 
#   rule_fill_discrete(columns = 1:7, 
#                      colours = c("PROTOCOL - TREES" = "#969696"))
```

...
###############################################################################
##FIRE FX TESTING??
computer <- igskmncnvs197.gs.doi.net
SQLServerInstances <- "IGSKMNCNVS357\SQLEXPRESS"
DatabaseNames <- c("FFI_RA_GRCA", "FFI_RA_IM_GRCA", "FFI_RA_WACA")
##
###############################################################################

importData(instance = "server", server = "IGSKMNCNVS357\\SQLEXPRESS", name = "FFI_RA_GRCA", new_env = TRUE)

instance = "server"
server = "IGSKMNCNVS357\\SQLEXPRESS"
name = "FFI_RA_GRCA"
new_env = TRUE
...
importData <- function(instance, server, name, new_env){

...
```{r}
# Blank data frame
errors_blank <- data.frame("SavedQuery" = "", "MacroPlot.Name" = "", "Date" = "", "Monitoring.Status" = "", "TagNo" = "", "Status" = "", "DBH" = "", "Ht" = "", "CrwnCl" = "", "LiCrBHt" = "", "Species.Symbol" = "", "Comment" = "", "Error" = "", "Fixed" = "", "Explanation" = "", "Queryers" = "") %>% 

...
```{r}
# Load in data
Fuels1000_all <- read.csv(paste0(data_path, "GRCA_FMH_2024_Surface Fuels - 1000Hr_XPT.csv"))
FuelsDuffLitt_all <- read.csv(paste0(data_path, "Surface Fuels - Duff_Litter_XPT.csv"))
FuelsFine_all <- read.csv(paste0(data_path, "Surface Fuels - Fine_XPT.csv"))
HerbsPoints_all <- read.csv(paste0(data_path, "Cover - Points (metric)_XPT.csv"))
HerbsObs_all <- read.csv(paste0(data_path, "Cover - Species Composition (metric)_XPT.csv"))
Shrubs_all <- read.csv(paste0(data_path, "Density - Belts (metric)_XPT.csv"))
Seedlings_all <- read.csv(paste0(data_path, "Density - Quadrats (metric)_XPT.csv"))
Trees_all <- read.csv(paste0(data_path, "Trees - Individuals (metric)_XPT.csv"))
#PostBurn_all <- read.csv(paste0(data_path, "Post Burn Severity_XPT.csv"))

# Blank data frame for no errors
errors_blank <- data.frame("SavedQuery" = "","MacroPlot.Name" = "","Date" = "","Error" = "No Error","Fixed" = "","Explanation" = "","Person" = "")
```

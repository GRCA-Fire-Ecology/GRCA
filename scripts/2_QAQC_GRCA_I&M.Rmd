...
# Mixed Conifer
path_data_M <- "X:/FFI Data Management/Exports from FFI/GRCA_I&M/M/2025-01-22/"
# Pinyon Juniper
path_data_P <- "X:/FFI Data Management/Exports from FFI/GRCA_I&M/P/2025-01-22/"
# Errors
...
errors_blank <- data.frame("SavedQuery" = "","MacroPlot.Name" = "","Date" = "","Error" = "No Error")
```
...
qaqc <- function(data, query, query_message, values_check) {
  ...
  errors <- data %>%   
    ...
    select("SavedQuery", "MacroPlot.Name", "Date", "Error")

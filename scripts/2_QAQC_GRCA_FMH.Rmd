...
errors_blank_HerbsPts <- data.frame("SavedQuery" = "PROTOCOL - HERBS POINTS","MacroPlot.Name" = "","Date" = "","Error" = "", "Fixed" = "", "Explanation" = "", "Queryers" = "")
```

...
values_valid <- c("", "ABGR", "BIRD", "BROK", "BROM", "CONK", "CROK", "DTOP", "FIRE", "FORK", "INSE", "LEAN", "LICH", "LIGT", "MAMM", "MISL", "ROOT", "SPAR", "SPRT", "TWIN", "WOND")
values_check <- !values_data %in% values_valid
...
errors_Trees_DamCd_Blank <- rbind(errors_Trees_DamCd_1_Blank_2, errors_Trees_DamCd_1_Blank_3,
...
-   Sort by DBH. Check that DBH ≥ 2.5 and not excessively large.

...
-   Check that Height = blank (i.e. no records should appear in the query)

### HerbsPoints Order

[Problem:]{.underline} Incorrect order numbers entered or order number missing.
...
# Identify errors
errors_HerbsPoints_Point <- qaqc(data, query, query_message, values_check)
```

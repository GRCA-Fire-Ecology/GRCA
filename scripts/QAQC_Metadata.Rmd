...
```{r}
errors_all <- rbind(errors_Disturbance, errors_blank, errors_MonStatus, errors_blank, errors_ProjectUnit, errors_blank, errors_TimeSince, errors_blank, errors_Visited)
```
